...
class ODEFunc_f(torch.nn.Module): # func_f
    def __init__(self, input_channels, hidden_channels):
...
class FinalTanh2(torch.nn.Module): 
    def __init__(self, input_channels, hidden_channels, hidden_hidden_channels, num_hidden_layers):
        super(FinalTanh2, self).__init__()
        self.input_channels = input_channels
        self.hidden_channels = hidden_channels
        self.hidden_hidden_channels = hidden_hidden_channels
        self.num_hidden_layers = num_hidden_layers
...
class ODEFunc_f2(torch.nn.Module): 
    def __init__(self, input_channels,hhidden_channels, hidden_channels):
        super(ODEFunc_f2, self).__init__()
        self.input_channels = input_channels
        self.hidden_channels = hidden_channels
        self.linear1 = torch.nn.Linear(hidden_channels, hhidden_channels)
        self.linear2 = torch.nn.Linear(hhidden_channels,  hidden_channels)
...
class Mapping_f(torch.nn.Module):
    def __init__(self, input_channels, hidden_channels):
        super(Mapping_f, self).__init__()
        self.input_channels = input_channels
        self.hidden_channels = hidden_channels
