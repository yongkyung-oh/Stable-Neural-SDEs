'''
https://github.com/patrick-kidger/NeuralCDE/blob/master/experiments/models/vector_fields.py
...
def GRU_ODE(input_channels, hidden_channels):
    ...
    return ncde_model.ContinuousRNNConverter(input_channels=input_channels,
